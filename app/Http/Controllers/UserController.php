...
class UserController extends Controller
{
    ...
    public function edit($id)
    {
       ...
       // dd($data);
        ...
        return view('users.form', compact('data','id', 'roles', 'profileImage', 'packages'));
    }
    ...
    public function update(UserRequest $request, $id)
    {
       ...
       // $user->userProfile->fill($request->userProfile)->update();
        ...
        if(auth()->check()){
            return redirect()->route('users.index')->withSuccess(__('User Detail Updated.',['name' => __('message.user')]));
        }
    ...
    public function changeStatus($id)
{
    ...
    return redirect()->back()->with('success', 'User status changed to ' . ucfirst($user->status) . '.');
}
