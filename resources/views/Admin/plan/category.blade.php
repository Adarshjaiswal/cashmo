            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addPackageModal">Add Plan Category</button>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addPackageModalLabel">Add Category</h5>
                            ...
                            <div class="mb-3">
                              ...
                              <select class="form-control " required>
                                ...
                                @foreach ($operators as $operator)
                                    <option value="{{$operator->id }}">{{ $operator->provider_name }}</option>
                                @endforeach
                              </select>
                            </div>
                            <div class="mb-3">
                                <label for="package_name" class="form-label">Category Name</label>
...
function fetchPackages(){
    ...
    $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route("AllPlanCategories.data") }}',
            type: 'GET',
        },
        columns: [
            { data: 'id', name: 'id' },
